    ...
    from-black to-gray-800 text-white">
      ...
      max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
          <form action="https://getform.io/f/a5a4acf6-d292-414a-b933-94a326354191" method="POST" className="flex flex-col w-full md:w-1/2">
            <input
              type="text"
              name="name"
            ...
            <input
              ...
              className="my-3 p-2 bg-transparent border-2 rounded-md
                text-white focus:outline-none"
            />
            ...
            from-cyan-500 to-blue-500 px-6 py-3 my-6 mx-auto flex items-center
